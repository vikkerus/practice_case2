...
day = int(input('Введите дату рождения в формате ДД: '))
month = int(input('Введите месяц рождения в формате ММ: '))
...
print(f"Дата рождения (в формате со звездочками): {'*'*day} {'*'*month} {'*'*year}")
